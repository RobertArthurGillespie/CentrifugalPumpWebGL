...
2. For complexes meshes with many submeshes, you will need to include multiple M_Outline materials - one for each submesh.
...
## To generate smooth normals:
Go to Tools -> Generate Smooth Normals, then drop in the mesh you want to generate smooth normals for.

## To use the smooth normals for a mesh that you have generated smooth normals for:
